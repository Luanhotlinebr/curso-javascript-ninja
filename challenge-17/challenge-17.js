(function () {
  ...
  */
  ...
  var newText = text.replace(
    ...
    "Luan Victor Paixao da Mota Sousa",
  );
  console.log(newText);
  ...
  */
  ...
  var replaceForMycity = text.replace(/(brasileiro)/, "cearense");
  console.log(replaceForMycity);
  ...
  */
  ...
  var replacedNumberToTraces = text.replace(/[0-9]/g, "-");
  console.log(replacedNumberToTraces);
  ...
  */
  ...
  var replacedTextToZero = text.replace(/[D-h]/g, "0");
  console.log(replacedTextToZero);
  ...
  */
  ...
  var replacedTextForFour = text.replace(/[A|a]/g, "4");
  console.log(replacedTextForFour);
  ...
  */
  ...
  var replacedTextWithNewPhrase = text.replace(
    /(O Centauro de Luvas)/,
    function (capturaTotal) {
      return capturaTotal.toUpperCase();
    },
  );
  console.log(replacedTextWithNewPhrase);
  ...
  */
  ...
  var regexDate = /(\d\d) de (junho|julho) de (\d\d\d\d)/gm;
